...
message = tk.Label(window, text="Face recognition", bg="yellow", fg="black", width=50,
...
takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black", bg="cyan"  ,width=20  ,height=3, activebackground = "green" ,font=('times', 20, 'bold'))
takeImg.place(x=200, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="cyan"  ,width=20  ,height=3, activebackground = "green",font=('times', 20, 'bold'))
